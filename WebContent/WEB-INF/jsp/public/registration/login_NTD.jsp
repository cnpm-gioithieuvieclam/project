                ...
                <div class="col-xs-12  padding0-xs">
                    ...
                    <div class="marginCenter width460">
                        ...
                        <form class="form-login form-login52" id="form-login" action="" method="POST">
                                ...
                                <p class="visible-xs fontSize20 txt-36 txc-mb marginTop15-mb">Nhà tuyển dụng đăng nhập</p>
                                                        ...
                                                        <div class="col-xs-12 padding0 form-group">
                                <input type="text" id="input-email" name="email" class="form-control input-login" placeholder="Email" />                                        	        <p id="error_email" class="hidden text-red error"></p>
                            ...
                            <div class="col-xs-12 padding0 checkbox ">
                                <label class="padding0 lblcheckbox ">
                                    <input type="checkbox" id="remember" name="remember" value="1" class="icheck" checked="checked" />                                    Nhớ đăng nhập
                                </label>
                            </div>
                    ...
                    <div class="marginCenter width460">
                        <div class="marginTop25 marginBottom35 marginCenter text-center floatLeft w100p-mb marginBottom15-mb marginTop10-mb">
                            <p class="txc-mb">Bạn chưa có tài khoản? <a href="https://viectotnhat.com/dang-ky" class="underline txt-green">Đăng ký</a><span class="hidden-xs">&nbsp;&nbsp;|&nbsp;&nbsp;<a href="https://viectotnhat.com/dang-nhap/nguoi-tim-viec" class="taga2 underline txt-36">Người tìm việc đăng nhập</a> </span></p>
                        </div>
                    </div>
                </div>
            </div>
